...
class Application_Form_User extends Zend_Form
{
	public function init()
	{
		...
		$rol = new Zend_Form_Element_Select('acl_roles_id_rol');
		$rol->setLabel('Role')
			->setRequired(true)
			->setMultiOptions($this->_getRolesPair())
			->addValidator('NotEmpty');
		
// 		include (APPLICATION_PATH."/models/Xhtmls.php");
		//$image= new Zend_View_Helps_Form_Element_Xhtmls("image");
		//$image->setContent("<img src='asdasd.jpg'/>");
